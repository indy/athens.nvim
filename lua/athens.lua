...
local function get_groups()
  ...
  local groups = {
    AthensVisualSelection = { bg = colors.neutral_red, fg = colors.bg0 },
    ...
    AthensHlRed = { fg = colors.bg0, bg = colors.blue },
    AthensHlGreen = { fg = colors.bg0, bg = colors.green },
    AthensHlYellow = { fg = colors.bg0, bg = colors.yellow },
    AthensHlBlue = { fg = colors.bg0, bg = colors.blue },
    AthensHlPurple = { fg = colors.bg0, bg = colors.purple },
    AthensHlAqua = { fg = colors.bg0, bg = colors.aqua },
    AthensHlOrange = { fg = colors.bg0, bg = colors.orange },
    ...
    Visual = { link = "AthensVisualSelection" },
